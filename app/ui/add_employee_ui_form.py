...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_role = QtWidgets.QLabel(parent=Form)
        self.label_role.setGeometry(QtCore.QRect(50, 360, 200, 30))
        self.label_role.setObjectName("label_role")

        self.comboBox_role = QtWidgets.QComboBox(parent=Form)
        ...
        self.listWidget_employees = QtWidgets.QListWidget(parent=Form)
        self.listWidget_employees.setGeometry(QtCore.QRect(50, 570, 600, 100))
        self.listWidget_employees.setObjectName("listWidget_employees")
